...
/**
 * Class PropertyFilterTypeFactory
 */
class PropertyFilterTypeFactory extends AbstractTypeFactory implements PropertyFilterFactory
{
    public function create($type) : PropertyFilter
    {
