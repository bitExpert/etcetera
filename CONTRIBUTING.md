...
If you wish to contribute to Etcetera, please be sure to
read/subscribe to the following resources:

 -  [The PSR-2 Coding Standard](http://www.php-fig.org/psr/psr-2/)

If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/etcetera/issues/new).
...
```console
$ git clone git@github.com:bitExpert/etcetera.git
$ cd etcetera
```
...
2. Fork the repository (http://github.com/bitExpert/etcetera)
...
```console
$ git remote add {username} git@github.com:{username}/etcetera.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical Etcetera repository.
...
To ssh://git@github.com/{username}/etcetera.git
